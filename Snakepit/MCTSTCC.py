...
##################################################################################################################################
# CALCULATE ECKART TUNNELING COEFFICIENT FOR THE LOWEST TEMPERATURE WHILE VARYING THE ENERGY RESOLUTION OF THE TUNNELING INTEGRAL.
##################################################################################################################################
...
RE = IRc['Energy'].loc[0]+IRc['ZPE'].loc[0] + IRCCC
TSE = TSminE + TSCCC
PE = Pc['Energy'].loc[0]+Pc['ZPE'].loc[0] + PCCC 
